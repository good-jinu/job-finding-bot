...
const ChatInterface = () => {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "1",
      content: "Hello! I'm your job finding assistant. I can help you search for jobs, analyze job postings against your resume, and create tailored resumes. What would you like to do today?",
      role: "assistant",
      timestamp: new Date(),
    }
  ]);
